#############################################################################
# Makefile for building: exindex-qt
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  exindex-qt.pro
# Template: app
# Command: C:\Qt\5.3.2\bin\qmake.exe USE_UPNP=- -o Makefile exindex-qt.pro
#############################################################################
...
Makefile: exindex-qt.pro ../../Qt/5.3.2/mkspecs/win32-g++/qmake.conf ../../Qt/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile exindex-qt.pro
...
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\deps\exindex-master\exindex-qt_plugin_import.cpp
